...
class BasicFunctionsPage extends StatelessWidget {
  const BasicFunctionsPage({super.key});
...
''';
  ...
  Widget build(BuildContext context) {
    return _FunctionTemplate(
      ...
      code: getCode(),
      explanation:
          "Funções podem ter tipo de retorno, corpo com return, retorno void e sintaxe curta com =>.",
    );
  }
}
