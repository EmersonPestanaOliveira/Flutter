...
class FunctionEqualityPage extends StatelessWidget {
  const FunctionEqualityPage({super.key});
...
''';
  ...
  Widget build(BuildContext context) {
    return _FunctionTemplate(
      title: "Igualdade e identidade",
      code: getCode(),
      explanation:
          "Funções podem ser comparadas por identidade usando identical, verificando se referenciam a mesma função.",
    );
  }
}
