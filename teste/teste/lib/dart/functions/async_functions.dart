...
class AsyncFunctionsPage extends StatelessWidget {
  const AsyncFunctionsPage({super.key});
...
''';
  ...
  Widget build(BuildContext context) {
    return _FunctionTemplate(
      ...
      code: getCode(),
      explanation:
          "Funções assíncronas usam Future, async e await. Você também pode tratar resultados com then() e erros com catchError().",
    );
  }
}
