...
class Relatorio implements Impressora {
  @override
  void imprimir() {
...
''';
  ...
  Widget build(BuildContext context) {
    return _ClassTemplate(
      ...
      code: getCode(),
      explanation:
          "Em Dart, qualquer classe pode ser usada como interface usando implements. A classe precisa implementar todos os membros.",
    );
  }
}
