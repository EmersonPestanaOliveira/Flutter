...
class ClasseGenericaPage extends StatelessWidget {
  const ClasseGenericaPage({super.key});
...
''';
  ...
  Widget build(BuildContext context) {
    return _ClassTemplate(
      ...
      code: getCode(),
      explanation:
          "Uma classe genérica usa tipos parametrizados, como <T>, para funcionar com diferentes tipos sem perder segurança.",
    );
  }
}
