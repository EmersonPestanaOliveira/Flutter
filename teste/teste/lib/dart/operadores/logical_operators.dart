...
class LogicalOperatorsPage extends StatelessWidget {
  const LogicalOperatorsPage({super.key});
...
''';
  ...
  Widget build(BuildContext context) {
    return _Template(
      ...
      code: getCode(),
      explanation:
          "Os operadores lógicos trabalham com valores booleanos e permitem combinar ou inverter condições.",
    );
  }
}
