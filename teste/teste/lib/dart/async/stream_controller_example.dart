...
class StreamControllerExamplePage extends StatelessWidget {
  const StreamControllerExamplePage({super.key});
...
''';
  ...
  Widget build(BuildContext context) {
    return _AsyncTemplate(
      ...
      code: getCode(),
      explanation:
          "StreamController permite criar uma Stream manualmente e emitir eventos com add(). É útil quando você controla a origem dos dados.",
    );
  }
}
