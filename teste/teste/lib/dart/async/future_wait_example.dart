...
class FutureWaitExamplePage extends StatelessWidget {
  const FutureWaitExamplePage({super.key});
...
Future<String> carregarPedidos() async {
...
''';
  ...
  Widget build(BuildContext context) {
    return _AsyncTemplate(
      ...
      code: getCode(),
      explanation:
          "Future.wait executa várias Futures em paralelo e retorna uma lista com todos os resultados quando todas terminarem.",
    );
  }
}
