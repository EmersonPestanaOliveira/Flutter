...
class PlacasInfoScreen extends StatelessWidget {
  const PlacasInfoScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<PlacasInfoSection>>(
        future: PlacasService().fetchInfoSections(),
